                        ...
                        if(isset($_SESSION['id_rol']) && $_SESSION['id_rol'] == "1") {
                            ...
                            echo "
                                ...
                                <button type='submit' style='background-color:transparent'>
                                    <a id='userPage' style='font-size:20px;background-color:transparent;color:darkcyan;font-weight:bold;text-trnsform:none;font-family:Georgia, 'Times New Roman', Times, serif;'><i class='usuario fa fa-user'></i> ".$_SESSION['usuario']."</a>
                                </button>
