...
<body>
    ...
    <div class="video"> 
        <div class="content">
            <h3>Ejercicio - Triceps</h3>
            <p>
                El músculo tríceps braquial es un músculo de tres cabezas (tri-tres cep-cabeza) ubicado en la región del brazo. 
                Corresponde al único constituyente del grupo muscular posterior de la región braquial, y se extiende a lo largo 
                de casi toda la extensión longitudinal del húmero.
            </p>
        </div>
        <div class="image-container">
            <div class="big-image">
                <iframe width="1000" height="510" src="https://www.youtube.com/embed/hTPkT1pZpdk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
