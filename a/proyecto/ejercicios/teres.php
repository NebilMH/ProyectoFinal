...
<body>
    ...
    <div class="video"> 
        <div class="content">
            <h3>Ejercicio - Teres</h3>
            <p>
                El músculo teres mayor viene de la escápula/paleta del hombro (parte principal de la paleta). 
                Se produce al hacer el centro de paleta. Las fibras musculares de este pequeño corte cónico corren 
                paralelas al eje largo de este músculo.
            </p>
        </div>
        <div class="image-container">
            <div class="big-image">
                <iframe width="1000" height="510" src="https://www.youtube.com/embed/GWm0KUm65bY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
