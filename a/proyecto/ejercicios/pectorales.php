...
<body>
    ...
    <div class="video"> 
        <div class="content">
            <h3>Ejercicio - Pectorales</h3>
            <p>
                Los pectorales son dos músculos de la zona anterior del tórax, llamados pectoral mayor y menor por su localización y 
                tamaño. Ambos son planos y con forma triangular, pero el mayor es más ancho que el otro. En cuanto a la acción muscular, 
                uno se encarga de mover el hombro mientras el otro moviliza la costillas.
            </p>
        </div>
        <div class="image-container">
            <div class="big-image">
                <iframe width="1000" height="510" src="https://www.youtube.com/embed/3IwHoFNQUo8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
