...
<body>
    ...
    <div class="video"> 
        <div class="content">
            <h3>Ejercicio - Gemelos</h3>
            <p>
                El gemelo es un músculo biarticular ya que su trayecto atraviesa dos articulaciones, la de la rodilla y el tobillo. 
                Su función sobre la rodilla es estabilizar el fémur, para evitar que haya un desequilibrio hacía adelante en los 
                movimientos de flexión.
            </p>
        </div>
        <div class="image-container">
            <div class="big-image">
                <iframe width="1000" height="510" src="https://www.youtube.com/embed/vbGkMjtQmD4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
