...
<body>
    ...
    <div class="video"> 
        <div class="content">
            <h3>Ejercicio - Isquiotibiales</h3>
            <p>
                Hay tres músculos que bajan por la parte posterior de la pierna, desde el muslo hasta la rodilla (el bíceps femoral, 
                el semitendinoso y el semimembranoso) que ayudan flexionar la rodilla y a extender la cadera. Conjuntamente, todos ellos 
                reciben el nombre de músculos isquiotibiales.
            </p>
        </div>
        <div class="image-container">
            <div class="big-image">
                <iframe width="1000" height="510" src="https://www.youtube.com/embed/gH-WCTYu9EY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
