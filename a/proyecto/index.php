                    ...
                    <?php 
                            if(isset($_SESSION['id_rol']) && $_SESSION['id_rol'] == "1") { //Si la sesion es de administrador, al hacer click en el nombre de usuario nos llevara a la pagina de administrador, tambien aparece el boron de cerrar sesion
                                echo "
                                    ...
                                    <a aria-label='cerrarS button' style='margin-left:10px;' href='php/cerrar-sesion.php'><i style='color:red;' class='closeS fa fa-sign-out' aria-hidden='true'></i></a>
                                ";
                                ...
                                echo "
                                    ...
                                    <button type='submit' style='background-color:transparent'>
                                        <a id='userPage' style='background-color:transparent;color:darkcyan;font-weight:bold;text-trnsform:none;font-family:Georgia, 'Times New Roman', Times, serif;'><i class='usuario fa fa-user'></i> ".$_SESSION['usuario']."</a>
                                    </button>
                                    <a aria-label='cerrarS button' style='' href='php/cerrar-sesion.php'><i style='color:red;' class='closeS fa fa-sign-out' aria-hidden='true'></i></a>
                                ";
                            } 
                    ?>
                </form>
