    ...
    <body>
        ...
        <header>
            ...
            <div class="icons">
                ...
                <?php 
                        if(isset($_SESSION['id_rol']) && $_SESSION['id_rol'] == "1") {//Si la sesion es de administrador, al hacer click en el nombre de usuario nos llevara a la pagina de administrador, tambien aparece el boron de cerrar sesion
                            echo "
                                <a href='../php/verFavoritos.php'><i id='heart' class='fa fa-heart'></i><span style='color:transparent'>.</span></a>
                                <a href='../php/carrito.php'><i id='cart' class='fa fa-shopping-cart'></i><span style='color:transparent'>.</span>$numero</a>
                                <a id='userPage' class='userandicon' href='../php/admin-usuarios.php' style='background-color:transparent;color:darkcyan;font-weight:bold;text-trnsform:none;font-family:Georgia, 'Times New Roman', Times, serif;'><i class='usuario fa fa-user'></i> ".$_SESSION['usuario']."<span style='color:transparent'>.</span></a>
                            ...
                            echo "
                                ...
                                <button type='submit' style='background-color:transparent'>
                                    <a id='userPage' class='userandicon' style='background-color:transparent;color:darkcyan;font-weight:bold;text-trnsform:none;font-family:Georgia, 'Times New Roman', Times, serif;'><i class='usuario fa fa-user'></i> ".$_SESSION['usuario']."<span style='color:transparent'>.</span></a>
                                </button>
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                <div class="box">
                    <form action="" method="post">
                        ...
                        <input type="hidden" name="imagen" value="../images/productos/<?php echo $row['imagen'] ?>">
                        ...
                        <div class="icons">
                            <?php
                                if(isset($_SESSION['id_rol']) && $_SESSION['id_rol'] == "1") {
                                    echo '<button onclick="this.form.action=\'../php/aniadirFavoritos.php\';this.form.submit();" aria-label="heart button" id="heart" style="background-color:transparent;border:1px solid black;border-radius:4px;height:35px;margin-top:5px;font-size:15px;" type="submit" class="heart fa fa-heart"></button>';
                                    echo '<button onclick="this.form.action=\'../php/carrito.php\';this.form.submit();" aria-label="cart button" id="cart" style="background-color:transparent;border:1px solid black;border-radius:4px;height:35px;margin-top:5px;font-size:15px;" type="submit" class="cart fa fa-shopping-cart"></button>';
                    ...
                    <div class="icons">
                        <?php
                            if(isset($_SESSION['id_rol']) && $_SESSION['id_rol'] == "1") {
                                ...
                                echo '<button onclick="this.form.action=\'../php/favoritos.php\';" aria-label="heart button" id="heart" style="background-color:transparent;border:1px solid black;border-radius:4px;height:35px;margin-top:5px;font-size:15px;" type="submit" class="heart fa fa-heart"></button>';
                                echo '<button onclick="this.form.action=\'../php/carrito.php\';" aria-label="cart button" id="cart" style="background-color:transparent;border:1px solid black;border-radius:4px;height:35px;margin-top:5px;font-size:15px;" type="submit" class="cart fa fa-shopping-cart"></button>';
                            } else {
                                echo '';
                            }
                        ?>
