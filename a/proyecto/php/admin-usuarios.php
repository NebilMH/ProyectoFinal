...
<body>
    ...
    <header>
        <div class="header" style="padding: 1rem 9%;">
            ...
            <h1>
                ...
                <?php 
                    echo "<a id='userPage' href='#' style='background-color:transparent;color:darkcyan;font-weight:bold;text-trnsform:none;font-family:Georgia, 'Times New Roman', Times, serif;'><i class='usuario fa fa-user'></i> ".$_SESSION['usuario']."</a>
                    <a aria-label='cerrarS button' style='margin-left:10px;' href='cerrar-sesion.php'><i style='color:red;' class='closeS fa fa-sign-out' aria-hidden='true'></i></a>";
                ?>
            </h1>
        </div>
    </header>
                ...
                <table class="tabla-usuarios" >
                    <thead>
                        <tr class="topTable">
                            ...
                            <td style="background-color: #3cc0b5;" id="idRol"><b>Id Rol</b></td>
                            ...
                            <td style="background-color: #3cc0b5;" id="idUser"><b>Usuario</b></td>
