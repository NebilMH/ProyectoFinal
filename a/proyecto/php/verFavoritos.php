					...
					<div class="col-lg-12">
						<div class="wrap">
								<div class="login-wrap p-4">
									<div class="d-flex">
										<div class="w-100">
                                                <button type="button" class="btnAtrasP" onclick="location.href='../shop/index.php'"><i class="fa-solid fa-arrow-left"></i> Volver</button>
                                                                            ...
                                                                            while(($row = mysqli_fetch_array($result))){
                                                                                echo "<tr>
                                                                                    ...
                                                                                    <td style='font-size:25px'>".$row['precio']."€</td>
                                                                                                <td><form action='eliminarProductoFavorito.php' method='POST'>
                                                                                                    <input type='hidden' name='id' value='".$row['id']."' >
                                                                                                    <button style='background-color:transparent;'><i style='color:red;' class='fa-solid fa-trash'></i></button>
                                                                                                </form></td>
                                                                                                ...
                                                                                                <td><form action='carrito.php' method='POST'>
                                                                                                    ...
                                                                                                    <button style='background-color:transparent;'><i style='color:green;' class='cart fa fa-shopping-cart'></i></button>
                                                                                                </form></td>
                                                                                    
                                                                                </tr>";
                                                                            }
                                                                        } else {
                                                                            echo '<p style="color:black;">No hay productos en tu lista de deseos...</p>';
                                                                        }
                                                                    ?>
                                                            </thead>
                                                        </table>
