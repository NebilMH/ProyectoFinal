    ...
    <div class="tablas">
        ...
        <div class="usuarios">
            <div class="formulario_U">
                <form id="formularioU" class="formularioU" method="post" action="editarFactura.php">
                    ...
                    <ul style="background-color: white;" id="seccion_crear-usuario">
                        ...
                        <div>Id Usuario: <input id="update_id_usuario" name="Eid_usuarioF" type="text" readonly></div>
                        <div>Id Producto: <input id="update_id_producto" name="Eid_productoF" type="text" readonly></div>
                        <div>Producto: <input id="update_productoF" name="EproductoF" type="text"/></div>
                        <div>Precio: <input id="update_precioF" name="EprecioF" type="text"/></div><br>
                        <button type="submit" class="editUser">Actualizar Factura</button>
                    </ul>
                </form>
            </div><hr>
