				...
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						...
						<div class="login-wrap p-4 p-md-5">
                            <div class="d-flex">
                                <div class="w-100">
                                    <a href="pedidos.php"><button class="pedidos">Mis pedidos <i class="fa-solid fa-receipt"></i></button></a>
                                    <a href="verFavoritos.php"><button class="favoritosP">Favoritos <i class="fa-solid fa-heart"></i></button></a>
                            ...
                            <form style="line-height: 1;" action="editarUsuario-tienda.php" method="post" class="signin-form">
                                ...
                                <label for="contrasenialbl">Contraseña:</label>
                                    <input id="contrasenialbl" name="Econtrasenia" type="text" placeholder="Introduzca su contraseña" class="form-control">
                                </div>
