									...
									<div class="w-100">
										...
										<form action="instalador.php" method="post" class="signin-form">
											<div class="form-group mt-6">
												...
												<input name="bd" id="usuario" type="text" placeholder="Nombre de la base de datos" class="form-control" pattern="^[a-zA-Z0-9_.-]*$" maxlength="20" required>
											</div>

											<div class="form-group mt-5">
												<label for="email" style="color:black;">Usuario Base de Datos:</label>
												<input name="usuarioBD" id="email" type="text" placeholder="Usuario de la base de datos" class="form-control" pattern="^[a-zA-Z0-9]*$" maxlength="25" required>
											</div>

											<div class="form-group">
												<label for="password-field" style="color:black;">Contraseña Base de Datos:</label>
												<input name="contraseniaBD" id="password-field" type="password" placeholder="Contraseña de la base de datos" class="form-control" pattern="^[a-zA-Z0-9]*$" maxlength="25" required>
