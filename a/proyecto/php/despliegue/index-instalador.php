...
<html lang="en">
	...
	<section class="ftco-section" style="padding: 3.5em 0;">
		<div class="container">
			...
			<li><b>Permiso necesario 1:</b> <span style="color:darkblue">sudo chmod +x /var/www/html/ProyectoFinal/a/proyecto/php/despliegue/instalador.sh</span></li>
			<li><b>Permiso necesario 2:</b> <span style="color:green">sudo chmod -R 777 ProyectoFinal/a/</span></li><hr>
		</div>
			</div>
