...
if (isset($_SESSION['bd'])) {
    ...
    INSERT INTO `facturas` (`id`, `id_usuario`, `id_producto`, `producto`, `precio`) VALUES
    (19, 1, 39, 'Energy And Focus - Blue Raspbe', '25.99'),
    (20, 1, 40, 'Energy And Focus - Pineapple', '29.95'),
    (21, 1, 41, 'Energy And Focus - Peach', '29.95'),
    (22, 1, 39, 'Energy And Focus - Blue Raspbe', '25.99'),
    (23, 1, 40, 'Energy And Focus - Pineapple', '29.95'),
    (24, 1, 41, 'Energy And Focus - Peach', '29.95');
