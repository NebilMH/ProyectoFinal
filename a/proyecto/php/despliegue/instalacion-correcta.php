...
if (isset($_SESSION['bd'])) {
    ...
    CREATE DATABASE IF NOT EXISTS `".$_SESSION['bd']."` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
    USE `".$_SESSION['bd']."`;
    ...
    ALTER TABLE `soporte`
    ADD CONSTRAINT `soporte_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
    COMMIT;
			...
			<p>Establezca sus credenciales de administrador</p>
                ...
                <form action="setAdmin.php" method="post" class="signin-form">
                    <div class="form-group mt-5">
                        ...
                        <input name="adminuser" id="email" type="text" placeholder="Usuario" class="form-control" maxLength="40" pattern="^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$" required>
                    </div>

                    <div class="form-group">
                        <label for="password-field" style="color:black;">Contraseña:</label>
                        <input name="adminpass" id="password-field" type="password" placeholder="Contraseña" pattern="^[a-zA-Z0-9]*$" maxlength="35"class="form-control" required>
