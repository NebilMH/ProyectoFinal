<?php
    ...
    if(isset($_POST['CproductoF'])) {//Comprobamos si esta establecida la url, en su caso la almacenamos
        $id = $connection->real_escape_string($_POST['id']);
        $producto = $connection->real_escape_string($_POST['CproductoF']);
        $precio = $connection->real_escape_string($_POST['CprecioF']);

	if($producto && $precio){//Si los campos no estan vacios ejecuta la consulta
				...
				<div id="cajaBlanca" class="col-md-7 col-lg-5">
					<div class="wrap">
							<div class="login-wrap p-4 p-md-5">
								<div class="d-flex">
									<div class="w-100">
										<h4 class="mb-4">Factura añadida correctamente</h4>			
									</div>
								</div>
