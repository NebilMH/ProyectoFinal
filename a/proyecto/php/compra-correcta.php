<?php  
    ...
    $query="SELECT * FROM facturas WHERE id_usuario='$id' ORDER BY fecha_compra DESC"; 
    ...
    for ($i=0; $i < sizeof($_SESSION['datos']); $i++) {
        ...
        $query = "INSERT INTO facturas (id_usuario, id_producto, codigo_pedido, producto, precio) 
        VALUES ('$id_usuario', '$id_producto', '$codigo_pedido', '$producto', '$precio')";
        $result = mysqli_query($connection, $query);
    }
?>
