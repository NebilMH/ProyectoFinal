<?php
    ...
    if(isset($_POST['EnombreS'])) {
        $id = $_POST['id'];
        $nombre = $_POST['EnombreS'];
        $email = $_POST['EemailS'];
        $asunto = $_POST['EasuntoS'];
        $mensaje = $_POST['EmensajeS'];

        $query = "UPDATE soporte SET nombre= '$nombre', email= '$email', asunto= '$asunto', mensaje= '$mensaje' WHERE id= '$id'"; 
                    ...
                    <div id="cajaBlanca" class="col-md-7 col-lg-5">
                        <div class="wrap">
                                <div class="login-wrap p-4 p-md-5">
                                    <div class="d-flex">
                                        <div class="w-100">
                                            <h4 class="mb-4">Soporte editado correctamente</h4>
                                        </div>
                                    </div>
...
<?php
        ...
        echo "<script type='text/javascript'>window.location.href = 'admin-soporte.php';</script>";
    }
