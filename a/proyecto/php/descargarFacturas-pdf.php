        ...
        <tbody>
            <?php foreach($json as $factura) { ?>
                <tr>
                    ...
                    <td style="border: 1px solid black;"><?php echo $producto['id_usuario'];?></td>
                    <td style="border: 1px solid black;"><?php echo $producto['id_producto'];?></td>
                    <td style="border: 1px solid black;"><?php echo $producto['producto'];?></td>
