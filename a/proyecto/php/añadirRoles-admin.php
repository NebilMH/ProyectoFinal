<?php
    ...
    if(isset($_POST['Crol'])) {//Comprobamos si esta establecida la url, en su caso la almacenamos
        $rol = $connection->real_escape_string($_POST['Crol']); 

	if($rol){//Si los campos no estan vacios ejecuta la consulta
