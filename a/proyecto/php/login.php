<?php
	...
	session_start(); //Iniciamos sesion y la destruimos para que no haya ninguna sesion activa a la hora de registrase o inciar sesion
	session_destroy();
?>
		...
		<form action="comprobarLogin.php" method="post" class="signin-form">
			...
			<div class="form-group d-md-flex">
				<div class="w-100 text-md-right">
					<a href="olvidar-contrasenia.php" style="color:black;">Olvidé mi contraseña</a>
				</div>
			</div>
		</form>
